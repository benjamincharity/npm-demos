...
export function config(bcKeypadConfigProvider) {
    ...
    /*
     *bcKeypadConfigProvider.numbers = [9, 8, 7, 6, 5, 4, 3, 2, 1, 0];
     */
...
<g>
  ...
  <path d="M329.6,208c-12.1-28.3-40.1-48-73.1-48h-112c-44.2,0-80.5,35.3-80.5,79.5v32c0,44.2,36.3,80.5,80.5,80.5H192
    ...
    /*
     *bcKeypadConfigProvider.setBackspaceTemplate(submitTemplate);
     *bcKeypadConfigProvider.setSubmitTemplate(backspace);
     */
